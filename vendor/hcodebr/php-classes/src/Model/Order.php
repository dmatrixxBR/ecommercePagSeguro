...
class Order extends Model {
	...
	public function get($idorder)
	{
		...
		$results = $sql->select("
			SELECT 
			a.idorder, a.idcart, a.iduser, a.idstatus, a.idaddress,
			a.vltotal, a.dtregister,
			b.desstatus,
			c.dessessionid, c.deszipcode, c.vlfreight, c.nrdays,
			d.idperson, d.deslogin,
			e.desaddress, e.desnumber, e.descomplement, e.descity,
			e.desstate, e.descountry, e.deszipcode, e.desdistrict,
		...
		)
	{
		...
		$sql->query("CALL sp_orderspagseguro_save(:idorder, :descode, :vlgrossamount, :vldiscountamount, :vlfeeamount, :vlnetamount, :extraamount, :despaymentlink)" , [
			':idorder'=>$this->getidorder(),
			':descode'=>$descode,
